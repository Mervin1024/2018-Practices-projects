//
//  MERDiffusePresentationInteractive.m
...
@interface MERDiffusePresentationInteractive ()
...
@implementation MERDiffusePresentationInteractive
...
- (void)handlePan:(UIScreenEdgePanGestureRecognizer*)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        CGFloat progress = [recognizer translationInView:_dismissedVC.view].x / (_dismissedVC.view.bounds.size.width * 1.0);
        ...
        if (@available(iOS 11.0,*)) {
            ...
            CGPoint velocity = [recognizer velocityInView:_dismissedVC.view];
